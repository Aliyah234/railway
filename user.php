...
<body>
   ...
   <div class="d-none" id="main">
      <nav id="navbar" class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
         <div class="container">
            <a class="navbar-brand" href="index.php">HHR</a>
      ...
      <section class="banner-area jumbotron position-relative" id="home">
         ...
         <div class="container">
            <div class="banner-content position-relative d-flex flex-column align-items-center justify-content-center">
               <h2 class="text-white display-4">Welcome to HHR</h2>
               <p class="text-white mt-3 mb-5">
                  Quick HHR Local Train Booking
               </p>
            </div>
         </div>
      </section>
               ...
               <div class="convert-wrap p-5">
                  ...
                  <div class="row justify-content-center align-items-start">
                     ...
                     <div class="col-lg-4 text-white">
                        ...
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="class" id="economy" value="2" checked>
            ...
            <div class="row d-flex justify-content-center">
               <div class="menu-content pb-60 col-lg-8">
                  <div class="title text-center">
                     <h2 class="mb-3">Why Choose HHR to Book Local Tickets ?</h2>
                  </div>
               </div>
            </div>
            <div class="col-sm-6">
